...
class WeightNet(nn.Module):
    ...
    def forward(self, x, x_gap):
        ...
        x = F.conv2d(x, weight=x_w, stride=self.stride, padding=1, groups=batch_size, bias=None)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option='B'):
        ...
        self.reduce = nn.Conv2d(in_planes, max(16, planes), 1, 1, 0, bias=True)
