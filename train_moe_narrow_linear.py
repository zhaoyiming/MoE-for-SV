...
from models.resnet56_moe_all_linear import  resnet56, L1_loss
from config.config_moe_narrow_linear import Config
from models.resnet56 import resnet_origin
...
if __name__ == '__main__':
    ...
    # model1=resnet_origin().to(device)
    # input1=torch.ones(1, 3, 32, 32).to(device)
