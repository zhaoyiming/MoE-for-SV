...
from config.config_moe_wide_0005 import Config
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, data in enumerate(train_loader):
        ...
        losses_basenet.update(loss_basenet.data.item(), data[0].size(0))
        losses_moe.update(loss_moe.data.item(), data[0].size(0))
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, opt.max_epoch):
        ...
        print(opt.para_miu, opt.para_lambda)
